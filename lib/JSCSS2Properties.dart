...
@JS()
@staticInterop
class JSCSS2Properties {}

extension JSCSS2PropertiesExtension on JSCSS2Properties {
  ...
  external String get markerOffset;
  ...
  external String get pitch;

  external String get pitchRange;

  external String get playDuring;

  external String get position;

  external String get quotes;

  external String get richness;
  ...
  external String get speakHeader;

  external String get speakNumeral;

  external String get speakPunctuation;

  external String get speechRate;

  external String get stress;
  ...
  external set azimuth(String value);
  ...
  external set elevation(String value);
  ...
  external set markerOffset(String value);
  ...
  external set pitch(String value);

  external set pitchRange(String value);

  external set playDuring(String value);

  external set position(String value);

  external set quotes(String value);

  external set richness(String value);
  ...
  external set speakHeader(String value);

  external set speakNumeral(String value);

  external set speakPunctuation(String value);

  external set speechRate(String value);

  external set stress(String value);
  ...
  external set volume(String value);
